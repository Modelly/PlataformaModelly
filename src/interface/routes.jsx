  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/consumidor/pedido-personalizado/publicar" element={<Publicar/>}/>
        <Route path="/consumidor/pedido-personalizado/categorias" element={<EscolhaCategoria/>}/>
        <Route path="/consumidor/pedido-personalizado/formulario" element={<FormularioServicos/>}/>

        <Route path="/artesao/pedido-personalizado" element={<CategoriaCliente/>}/>
        <Route path="/artesao/pedido-personalizado/publicar" element={<Publicar/>}/>
        <Route path="/artesao/pedido-personalizado/categorias" element={<EscolhaCategoria/>}/>
        <Route path="/artesao/pedido-personalizado/formulario" element={<FormularioServicos/>}/>
